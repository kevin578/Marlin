...
#define STRING_CONFIG_H_AUTHOR "(Kevin Briggs)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Kevin's Thingomatic"
...
#define DEFAULT_XYJERK                (30.0*60)    // (mm/sec)
#define DEFAULT_ZJERK                 (1.0*60)     // (mm/sec)
#define DEFAULT_EJERK                 (5.0*60)     // (mm/sec)
